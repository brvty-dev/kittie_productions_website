...
def adam():
    ...
    return render_template("login_pages/adam.html", user=current_user, kittie_production=kittie_production)
...
def login():
            ...
            # Check if the provided password matches the hashed password in the database
                if check_password_hash(user.password, password):
                    ...
                    if current_user.is_authenticated:
                        return redirect(url_for('prod.kittie_productions', user=current_user, kittie_production=kittie_production))
                else:
    ...
    return render_template("login_pages/login.html", user=current_user, kittie_production=kittie_production)
...
def forgotten_password():
    ...
    return render_template("login_pages/forgotten_password.html", user=current_user, kittie_production=kittie_production)
    ...
    if request.method == 'POST':
        ...
        if not re.match(password_pattern, password):
            ...
            if user:
                ...
                return redirect(url_for('prod.kittie_productions', user=current_user.id))
            else:
                flash('Invalid or expired token.', category='error')
        
    return render_template("login_pages/update_password.html", user=current_user, kittie_production=kittie_production)